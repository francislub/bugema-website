...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form role="form" method="POST" action="includes/publication.php" enctype="multipart/form-data">
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<a href='includes/update_publication.php?id=" . $row["id"] . "'> <button class='btn btn-primary'style='margin-right: 5px;'><i class='fa fa-edit'></i> Edit</button></a>";      
                            echo "<a href='includes/del_pub.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete?\");'> <button class='btn btn-danger'><i class='fa fa-trash'></i> Delete</button></a>";
                            echo "</div";
                            echo "</td>";
                            echo '</tr>';
                        }
